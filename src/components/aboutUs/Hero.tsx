...
const Hero: React.FC = () => {
  return (
    <div className="bg-black py-[48px] sm:py-[82px] lg:py-[104px] text-left flex flex-col justify-center items-start sm:px-[50px] lg:px-[84px] px-[24px]">
      ...
      <p className="text-[gray] lg:text-[28px] sm:text-[14px] text-[8px]">
        ...
        mind, and spirit, empowering you to live a balanced and fulfilling life.
      </p>
    </div>
  );
};
