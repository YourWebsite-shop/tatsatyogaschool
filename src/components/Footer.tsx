        ...
        <div className="right-0 lg:pr-[0px] sm:pr-[40px] px-[18px] sm:px-0 lg:w-[400px] sm:w-1/2">
          ...
          <div className="lg:pb-[16px] sm:pb-[20px] pb-[16px]">
            <p className="flex text-[#EAE6E1] lg:text-[14px] sm:text-[16px] text-[14px]  ">
              <TiLocation className="lg:mr-2 mr-1 h-[24px] w-[28px] sm:h-[21px] sm:w-[30px] lg:h-[32px] lg:w-[46px] bg-gray-800 rounded-full p-0.5 lg:-translate-y-1 sm:mt-[3px] mt-[0px] " />
          ...
          <div className="text-[#EAE6E1]">
            ...
            <div className="flex lg:pt-[24px] sm:pt-[20px] pt-[12px] lg:gap-3 sm:gap-2 gap-2">
              <div className="flex justify-center items-center bg-white text-black rounded-full p-1">
                <FaInstagram className="lg:h-[28px] lg:w-[28px] sm:h-[20px] sm:w-[20px] h-[26px] w-[26px]" />
              </div>
              <div className="rounded-full">
                <FaFacebook className="lg:h-[38px] lg:w-[38px] sm:h-[30px] sm:w-[30px] h-[34px] w-[34px] " />
              </div>
              <div className="flex justify-center items-center bg-white text-black p-1 rounded-full">
