    ...
    <section id="contactus">
      <div className="bg-[#EAE6E1] min-h-[90vh] relative py-12 lg:py-16">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
          <h1
            className="kaftan-text text-center text-2xl md:text-4xl lg:text-5xl font-medium text-white pb-6 md:pb-8 lg:pb-10 max-w-3xl"
            data-aos="fade-up"
            data-aos-delay="300"
          ...
          >
            ...
            <p className="text-center text-white text-xs md:text-sm mb-6">
              To book a class, fill out the form and our manager will contact
              you.
            </p>
