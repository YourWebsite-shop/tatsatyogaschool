...
const ContactDetail = ({ icon, title, description }) => (
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="mt-1 block w-full py-3 px-4 border border-neutral-300 rounded-md shadow-sm focus:ring-[#E67825] focus:border-[#E67825]"
                  />
                </div>
