...
const programsData: Program[] = [
  ...
  },
  {
    ...
    highlights: ["14 Days Beginner", "Certification Included", "No Prerequisites"],
    link: "#contact",
  },
  {
    id: 3,
...
const Programs: React.FC = () => {
  return (
    <div>
      <section
        id="programs"
        className="mt-[80px] sm:mt-[100px] lg:mt-[120px] py-[40px] sm:py-[50px] lg:py-[60px] bg-neutral-100"
      >
