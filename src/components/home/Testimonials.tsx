...
const Testimonials = () => {
  ...
  return (
    ...
    >
      <Image src={LeftBottom} alt="Decorative background" className='absolute top-0 right-0 rotate-180 opacity-50 w-32 translate-y-10 lg:translate-y-0 sm:w-44 xl:w-60 ' />
      <Image src={LeftBottom} alt="Decorative background" className='absolute bottom-0 left-0 opacity-50 w-32 sm:w-44 xl:w-60' />
