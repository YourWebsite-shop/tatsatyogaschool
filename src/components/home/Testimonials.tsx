...
const Testimonials = () => {
  ...
  return (
    ...
    >
      <Image src={RightTop} alt="Decorative background" className='absolute top-0 right-0 opacity-30 w-24 sm:w-32 md:w-44 lg:w-96' />
      <Image src={LeftBottom} alt="Decorative background" className='absolute bottom-0 left-0 opacity-30 w-24 sm:w-32 md:w-44 lg:w-80' />
